...
/// [`crate::marginal::debug_check_leaf_columns_pinned`] all re-derive it here rather than each
...
/// #4 in [`crate::marginal::debug_check_leaf_columns_pinned`] fires — scanning from 0 and taking
