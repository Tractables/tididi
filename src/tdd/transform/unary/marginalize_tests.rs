...
use crate::tdd::minimize::try_minimize;
use crate::tdd::query::{evaluate, model_count, RationalSemiring, WeightVal};
use crate::tdd::test_helpers::compile_clauses;
use crate::tdd::types::Tdd;
use crate::tdd::validate::marg::subsumed_marginal_data_violations;
