...
use crate::tdd::types::{MargRef, Tdd};
use crate::vtree::VtreeIdx;

use crate::tdd::marg_slots::{push_count_key, CountKey, SlotInterner};
...
pub(super) fn sum_marginal_weights(ws: &crate::tdd::weight_store::WeightStore, v: VtreeIdx, margs: &[u32]) -> WeightVal {
    {
