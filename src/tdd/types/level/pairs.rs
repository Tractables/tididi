...
use crate::tdd::types::marg::MargRef;
use crate::tdd::types::packed::PairsIter;
use crate::tdd::types::primitives::{
...
impl TddLevel {
    ...
    pub(crate) fn decode_pairs_into(
        ...
        for p in self.pairs_iter_of_idx(idx) {
            out.push(InputPair {
                left: LocalNodeIdx(crate::tdd::types::marg::decode_marg_coord(p.left.0, left_mask)),
                right: LocalNodeIdx(crate::tdd::types::marg::decode_marg_coord(p.right.0, right_mask)),
            });
        }
    }
